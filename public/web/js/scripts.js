...
$(function() {
  ...
  var toggle_sidebar_mini = function(mini) {
    ...
    if (!mini) {
      ...
      localStorage.removeItem('isMenuMini');
      $(".mini-menu").removeClass('ml-n3');
      $(".main-sidebar").css({
        overflow: 'hidden'
      });
      setTimeout(function() {
      ...
      localStorage.setItem('isMenuMini', 'true');
      $(".mini-menu").addClass('ml-n3');
  ...
  $(document).ready(function() {
    var isMenuMini = localStorage.getItem('isMenuMini');
    if (isMenuMini === 'true') {
